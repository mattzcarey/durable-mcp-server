/**
 * SSE-aware JSON-RPC helpers for the HTTP layer of the four-layer matrix:
 * real Streamable HTTP POSTs against the fixture worker's fetch surface.
 * Request-building idiom follows apps/task-server/test; the modern
...
export const MCP_URL = "http://fixture.test/mcp";
